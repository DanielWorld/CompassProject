package danielworld.compassproject.service;
...
public class GPSTracker extends Service implements LocationListener {
    ...
    public Location getLocation(){
        try{
            ...
            if(!isGPSEnabled && !isNetworkEnabled){
                LOG.e(TAG, "Neither GPS nor NETWORK isn't working!");
    ...
    /**
     * Stop tracking longitude & latitude
     */
    ...
    public void showSettingsAlert(final Context context){
        AlertDialogUtil.showMultiButtonDialog(context, "GPS settings", "GPS isn't enable, would you like to trun it on?", null, null, new DialogInterface.OnClickListener() {
            @Override
